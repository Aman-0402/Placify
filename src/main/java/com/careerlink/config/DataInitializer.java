...
import com.careerlink.enums.Role;
...
public class DataInitializer implements CommandLineRunner {
    ...
    private static final String ADMIN_PASSWORD = "Admin@CareerLink2026";
    private static final String RECRUITER_PASSWORD = "Recruiter@CareerLink2026";
    private static final String STUDENT_PASSWORD = "Student@CareerLink2026";
    ...
    public void run(String... args) {
        ...
        upsertUser("Aarav Mehta", "recruiter.microsoft@careerlink.com", RECRUITER_PASSWORD, Role.RECRUITER);
        upsertUser("Neha Kulkarni", "recruiter.amazon@careerlink.com", RECRUITER_PASSWORD, Role.RECRUITER);
        upsertUser("Rishi Bhatia", "recruiter.deloitte@careerlink.com", RECRUITER_PASSWORD, Role.RECRUITER);
        upsertUser("Kavya Reddy", "recruiter.infosys@careerlink.com", RECRUITER_PASSWORD, Role.RECRUITER);
        upsertUser("Arjun Nair", "recruiter.accenture@careerlink.com", RECRUITER_PASSWORD, Role.RECRUITER);
        upsertUser("Siddharth Jain", "recruiter.tcs@careerlink.com", RECRUITER_PASSWORD, Role.RECRUITER);

        upsertStudent(
                "Ananya Gupta",
                "ananya.gupta@careerlink.com",
                "Computer Science Engineering",
                "Java, Spring Boot, MySQL, REST APIs, DSA",
                "ananya-gupta-resume.pdf");
        upsertStudent(
                "Rohan Verma",
                "rohan.verma@careerlink.com",
                "Information Technology",
                "JavaScript, SQL, Node.js, React, Git",
                "rohan-verma-resume.pdf");
        upsertStudent(
                "Sneha Iyer",
                "sneha.iyer@careerlink.com",
                "Artificial Intelligence and Machine Learning",
                "Python, SQL, FastAPI, Machine Learning, Power BI",
                "sneha-iyer-resume.pdf");
        upsertStudent(
                "Aditya Rao",
                "aditya.rao@careerlink.com",
                "Electronics and Communication Engineering",
                "Java, DBMS, Operating Systems, Computer Networks",
                "aditya-rao-resume.pdf");
        upsertStudent(
                "Meera Nair",
                "meera.nair@careerlink.com",
                "Computer Science Engineering",
                "Spring Boot, Docker, PostgreSQL, Microservices, GitHub Actions",
                "meera-nair-resume.pdf");
        upsertStudent(
                "Kunal Singh",
                "kunal.singh@careerlink.com",
                "Data Science",
                "Python, Pandas, SQL, ETL, Data Visualization",
                "kunal-singh-resume.pdf");
        upsertStudent(
                "Ishita Kapoor",
                "ishita.kapoor@careerlink.com",
                "Computer Engineering",
                "DSA, Java, OOP, AWS Basics, Problem Solving",
                "ishita-kapoor-resume.pdf");
        upsertStudent(
                "Vivek Menon",
                "vivek.menon@careerlink.com",
                "Information Technology",
        ...
        upsertJob(
                ...
                "Microsoft",
                "recruiter.microsoft@careerlink.com",
        ...
        upsertJob(
                ...
                "Amazon",
                "recruiter.amazon@careerlink.com",
        ...
        upsertJob(
                ...
                "Deloitte",
                "recruiter.deloitte@careerlink.com",
        ...
        upsertJob(
                ...
                "Infosys",
                "recruiter.infosys@careerlink.com",
        ...
        upsertJob(
                ...
                "Accenture",
                "recruiter.accenture@careerlink.com",
        ...
        upsertApplication("ananya.gupta@careerlink.com", "Associate Software Engineer", "Microsoft", ApplicationStatus.SHORTLISTED);
        upsertApplication("ananya.gupta@careerlink.com", "Analyst - Technology Consulting", "Deloitte", ApplicationStatus.IN_REVIEW);
        upsertApplication("rohan.verma@careerlink.com", "Software Development Engineer I", "Amazon", ApplicationStatus.APPLIED);
        upsertApplication("rohan.verma@careerlink.com", "Application Development Associate", "Accenture", ApplicationStatus.IN_REVIEW);
        upsertApplication("sneha.iyer@careerlink.com", "Business Technology Analyst", "Deloitte", ApplicationStatus.SHORTLISTED);
        upsertApplication("sneha.iyer@careerlink.com", "Quality Engineering Analyst", "Accenture", ApplicationStatus.APPLIED);
        upsertApplication("aditya.rao@careerlink.com", "Systems Engineer Specialist", "Infosys", ApplicationStatus.SELECTED);
        upsertApplication("meera.nair@careerlink.com", "Associate Software Engineer", "Microsoft", ApplicationStatus.APPLIED);
        upsertApplication("meera.nair@careerlink.com", "Cloud Support Associate", "Microsoft", ApplicationStatus.IN_REVIEW);
        upsertApplication("kunal.singh@careerlink.com", "Data Engineering Associate", "Infosys", ApplicationStatus.SHORTLISTED);
        upsertApplication("ishita.kapoor@careerlink.com", "Software Development Engineer I", "Amazon", ApplicationStatus.REJECTED);
        upsertApplication("vivek.menon@careerlink.com", "Digital Engineering Trainee", "Tata Consultancy Services", ApplicationStatus.APPLIED);
    }
