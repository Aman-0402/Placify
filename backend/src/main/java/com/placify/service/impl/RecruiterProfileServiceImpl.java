...
public class RecruiterProfileServiceImpl implements RecruiterProfileService {
    ...
    public RecruiterProfileResponse updateOwnProfile(String email, RecruiterProfileUpdateRequest request) {
        ...
        if (request.getCompany() != null) profile.setCompany(request.getCompany().trim());
        if (request.getPosition() != null) profile.setPosition(request.getPosition().trim());
        ...
        if (request.getLinkedIn() != null) profile.setLinkedIn(request.getLinkedIn().trim());
